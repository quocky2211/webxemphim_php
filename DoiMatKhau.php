    ...
    <div class="container">
        ...
        <div class="container" style="margin-top: -100px;">
            <div class="row profile">
                ...
                <form action="./xuly/xulydoimatkhau.php" method="post">
                    <div class="col-md-9">
                        <div class="form-group" style="margin-top: 70px;">
                            <label for="username">Tên người dùng</label>
                            <input id="username" type="text" class="form-control" name="Name" required value="<?php echo $row['Name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password" class="form-control" name="ReEnterPassword" required >
                        </div>
                        <button type="submit" class="save_button" >
                            Lưu
                        </button>
                        <button class="cancel_button" onclick="location.href='thongtincanhan.php'">
                            Hủy
                        </button>
                    </div>
                </form>
