...
<div class="container" style="margin-top:30px">
  ...
  <div class="row">
        ...
        <div class=col-sm-12>
            <p class="h3">Danh Sách Quảng Cáo</p>
        </div>
        <div class="col-sm-12 mb-3" >
            <button class="btn btn-dark" onclick="document.location='ThemQuangCao.php'">Thêm Quảng Cáo</button>
        </div>
        <div class="col-sm-12 input-group mb-3">
          <input id="Search-txt" type="text" class="form-control" placeholder="Nhập Tên Công Ty">
    ...
    <div class=col-sm-12>  
      <table class="table table-bordered">
        ...
        <tbody id="ttbody">
            <?php require './xuly/xulyshowquangcao.php' ?>
        </tbody>
      </table>
    </div>  
  </div>
